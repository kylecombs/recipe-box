...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    return redirect(`/meal-plans/${mealPlan.id}`);
  } catch (error) {
...
export default function NewMealPlan() {
  ...
  // Initialize with a basic weekly structure
  const [weekPlan, setWeekPlan] = useState<MealPlanDay[]>([
    { day: "Monday", breakfast: { recipe: "", notes: "" }, lunch: { recipe: "", notes: "" }, dinner: { recipe: "", notes: "" } },
    { day: "Tuesday", breakfast: { recipe: "", notes: "" }, lunch: { recipe: "", notes: "" }, dinner: { recipe: "", notes: "" } },
    { day: "Wednesday", breakfast: { recipe: "", notes: "" }, lunch: { recipe: "", notes: "" }, dinner: { recipe: "", notes: "" } },
    { day: "Thursday", breakfast: { recipe: "", notes: "" }, lunch: { recipe: "", notes: "" }, dinner: { recipe: "", notes: "" } },
    { day: "Friday", breakfast: { recipe: "", notes: "" }, lunch: { recipe: "", notes: "" }, dinner: { recipe: "", notes: "" } },
    { day: "Saturday", breakfast: { recipe: "", notes: "" }, lunch: { recipe: "", notes: "" }, dinner: { recipe: "", notes: "" } },
    { day: "Sunday", breakfast: { recipe: "", notes: "" }, lunch: { recipe: "", notes: "" }, dinner: { recipe: "", notes: "" } },
  ]);
    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">
          Plan your meals manually for the week ahead
        </p>
      </div>
      ...
      <Form method="post" className="space-y-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g., Weekly Meal Plan - January 2024"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                placeholder="Add any cooking tips, prep notes, or reminders..."
              />
            </div>
          </div>
        </div>
        ...
        <input type="hidden" name="shoppingList" value={JSON.stringify(shoppingList.filter(item => item.item.trim()))} />
